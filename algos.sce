...
//test tablo=[[0 10];[0 1]]; interpol2val(tablo,3) -> .3
//test  listXY=[0 1 2; 0 1 0]; targetX=[-1 0 1 2 3]; interpol2val(listXY,targetX)
//test  listXY=[0 1 2; 0 1 0]; targetX=[-1 0 1 2 3]; interpol2val(listXY,1)
//test  listXY=[0 1 2; 0 1 0]; targetX=[-1 0 1 2 3]; interpol2val(listXY,-1)
